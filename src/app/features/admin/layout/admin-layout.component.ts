    ...
    <div class="admin-wrapper" [class.collapsed]="isCollapsed">
      ...
      <aside class="admin-sidebar shadow-lg">
        ...
        <nav class="sidebar-nav">
          ...
          <a routerLink="/app/admin/products" routerLinkActive="active" class="nav-item">
          ...
          <a routerLink="/app/admin/auctions" routerLinkActive="active" class="nav-item">
          ...
          <a routerLink="/app/home" class="nav-item back-btn">
      ...
      <main class="admin-main">
        <header class="admin-header px-4">
          <div class="breadcrumb text-secondary small">
            <span>Admin</span> / <span class="text-white">Dashboard</span>
          </div>
